          ...
          <div class="modal-dialog modal-lg">
            ...
            <div v-if="currentOrder" class="modal-content modal-lg">
              ...
              <div class="modal-body" style="width:100%;">
                ...
                <div style="width:225px;margin-left:calc((100% - 225px) / 2);margin-top:15px;float:left;">
                    <a style="float:left;line-height:30.75px;">Order Quantity : </a>
                    <input type="number" class="form-control" :max="currentOrder.available_units" @keyup="checkQuantity()" placeholder="units" style="width:100px;margin-left:10px;text-align:center;float:left;" v-model="currentOrder.quantity_ordered" />
                </div>
              </div>
