<template>
    <div class="vue_component__upload--image" v-bind:class="{ 'dragover': onDragover }">
        <form v-bind:id="'upload_image_form--' + input_id" enctype="multipart/form-data">
            ...
            <input type="file" name="images[]" v-bind:id="'upload_image_form__input--' + input_id" hidden multiple />
            <div>
                <button type="submit"
        ...
        methods: {
            ...
            fileDrop: function(e){
                ...
                for(let i = 0; i < newFiles.length; i++){
                    ...
                    this.actual_files.push(newFiles[i])
                ...
                this.$emit('files-changed', this.actual_files, this.images)
                e.target.value = '';
            },
